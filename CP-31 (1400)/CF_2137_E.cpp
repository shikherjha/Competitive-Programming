...
void solve() {
    ...
    // 2 ka period hoga, just need to calculate s1 and s2
    vector<int> a1 = helper(a);
    if(k==1){
        int sum = 0;
        for(int x : a1) sum += x;
        cout << sum << endl;
