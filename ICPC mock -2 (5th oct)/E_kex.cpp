...
// Initial thought of using set gave MLE, so there is pattern in this as 'a'
// doesn't contain duplicates we can see that missing elements can be a[i]-i
