...
/*
    actually laggedd in this problem, read problem wrong, thought to end the stream, but it shows, people can get stuck in
    any problem, no one is immortal in cp. consistency matters a lot.
*/
void solve() {
    int m,d; cin >> m >> d;
